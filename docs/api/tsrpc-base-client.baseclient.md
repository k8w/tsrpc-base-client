...
|  [lastSN](./tsrpc-base-client.baseclient.lastsn.md) |  | number | The <code>SN</code> number of last <code>callApi()</code>, which can be passed to <code>abort()</code> to abort an API request. |
