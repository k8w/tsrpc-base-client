...
|  [nextSN](./tsrpc-base-client.baseclient.nextsn.md) |  | (notInc?: boolean \| undefined) =&gt; number | The <code>SN</code> number of the next <code>callApi()</code>, which can be passed to <code>abort()</code> to abort an API request. |
